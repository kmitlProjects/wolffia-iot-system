...
function renderTimeseriesCapturePolicy(state) {
    ...
    if (!(chip instanceof HTMLElement) || !(copy instanceof HTMLElement) || !(lastCopy instanceof HTMLElement) || !(keepButton instanceof HTMLButtonElement) || !(forceOffButton instanceof HTMLButtonElement)) {
        return;
    }
...
async function refreshAnomalyWatchFast() {
