...
export function startWaterPump(durationSeconds: number): Promise<{ pump_water: unknown }> {
...
export function startAllFertilizerPumps(
...
export function stopAllFertilizerPumps(): Promise<{ pump_fertilizer: unknown }> {
